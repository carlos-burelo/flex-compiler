...
#line 53 "v.y"
                              { expresion((yyvsp[0].nPtr)); nodo_libre((yyvsp[0].nPtr)); }
#line 1340 "v.tab.c"
    break;
...
#line 59 "v.y"
                                           { (yyval.nPtr) = operacion(ASSIGN, 2, id((yyvsp[-3].vName), SET), (yyvsp[-1].nPtr)); }
#line 1364 "v.tab.c"
    break;

  case 9: /* statement: PRINT expression ';'  */
#line 60 "v.y"
                                 { (yyval.nPtr) = operacion(PRINT, 1, (yyvsp[-1].nPtr)); }
#line 1370 "v.tab.c"
    break;

  case 10: /* statement: PRINT STRING ';'  */
#line 61 "v.y"
                             { (yyval.nPtr) = operacion(PRINT, 1, constante((yyvsp[-1].sValue))); }
#line 1376 "v.tab.c"
    break;

  case 11: /* statement: SCAN VARIABLE ';'  */
#line 62 "v.y"
                              { (yyval.nPtr) = operacion(SCAN, 1, id((yyvsp[-1].vName), GET)); }
#line 1382 "v.tab.c"
    break;

  case 12: /* statement: WHILE expression THEN statement  */
#line 63 "v.y"
                                            { (yyval.nPtr) = operacion(WHILE, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1388 "v.tab.c"
    break;

  case 13: /* statement: FOR VARIABLE ':' '(' expression ',' expression ',' expression ')' THEN statement  */
#line 64 "v.y"
                                                                                             { (yyval.nPtr) = operacion(FOR, 5, id((yyvsp[-10].vName), GET), (yyvsp[-7].nPtr), (yyvsp[-5].nPtr), (yyvsp[-3].nPtr), (yyvsp[0].nPtr)); }
#line 1394 "v.tab.c"
    break;

  case 14: /* statement: IF expression THEN statement  */
#line 65 "v.y"
                                                   { (yyval.nPtr) = operacion(IF, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1400 "v.tab.c"
    break;

  case 15: /* statement: IF expression THEN statement ELSE statement  */
#line 66 "v.y"
                                                        { (yyval.nPtr) = operacion(IF, 3, (yyvsp[-4].nPtr), (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1406 "v.tab.c"
    break;
...
#line 71 "v.y"
                                          { (yyval.nPtr) = operacion(';', 2, (yyvsp[-1].nPtr), (yyvsp[0].nPtr)); }
#line 1424 "v.tab.c"
    break;

  case 19: /* expression: NUMBER  */
#line 74 "v.y"
                    { (yyval.nPtr) = condicion((yyvsp[0].dValue)); }
#line 1430 "v.tab.c"
    break;
...
#line 77 "v.y"
                                                      { (yyval.nPtr) = operacion(RANDOM, 2, (yyvsp[-3].nPtr), (yyvsp[-1].nPtr)); }
#line 1448 "v.tab.c"
    break;

  case 23: /* expression: LOG '(' expression ')'  */
#line 78 "v.y"
                                    { (yyval.nPtr) = operacion(LOG, 1, (yyvsp[-1].nPtr)); }
#line 1454 "v.tab.c"
    break;

  case 24: /* expression: LOG '(' expression ',' expression ')'  */
#line 79 "v.y"
                                                   { (yyval.nPtr) = operacion(LOG, 2, (yyvsp[-3].nPtr), (yyvsp[-1].nPtr)); }
#line 1460 "v.tab.c"
    break;

  case 25: /* expression: EXP '(' expression ')'  */
#line 80 "v.y"
                                    { (yyval.nPtr) = operacion(EXP, 1, (yyvsp[-1].nPtr)); }
#line 1466 "v.tab.c"
    break;

  case 26: /* expression: SQRT '(' expression ')'  */
#line 81 "v.y"
                                     { (yyval.nPtr) = operacion(SQRT, 1, (yyvsp[-1].nPtr)); }
#line 1472 "v.tab.c"
    break;

  case 27: /* expression: FLOOR '(' expression ')'  */
#line 82 "v.y"
                                      { (yyval.nPtr) = operacion(FLOOR, 1, (yyvsp[-1].nPtr)); }
#line 1478 "v.tab.c"
    break;

  case 28: /* expression: CEIL '(' expression ')'  */
#line 83 "v.y"
                                     { (yyval.nPtr) = operacion(CEIL, 1, (yyvsp[-1].nPtr)); }
#line 1484 "v.tab.c"
    break;

  case 29: /* expression: ABS '(' expression ')'  */
#line 84 "v.y"
                                    { (yyval.nPtr) = operacion(ABS, 1, (yyvsp[-1].nPtr)); }
#line 1490 "v.tab.c"
    break;

  case 30: /* expression: SIN '(' expression ')'  */
#line 85 "v.y"
                                    { (yyval.nPtr) = operacion(SIN, 1, (yyvsp[-1].nPtr)); }
#line 1496 "v.tab.c"
    break;

  case 31: /* expression: ASIN '(' expression ')'  */
#line 86 "v.y"
                                     { (yyval.nPtr) = operacion(ASIN, 1, (yyvsp[-1].nPtr)); }
#line 1502 "v.tab.c"
    break;

  case 32: /* expression: COS '(' expression ')'  */
#line 87 "v.y"
                                    { (yyval.nPtr) = operacion(COS, 1, (yyvsp[-1].nPtr)); }
#line 1508 "v.tab.c"
    break;

  case 33: /* expression: ACOS '(' expression ')'  */
#line 88 "v.y"
                                     { (yyval.nPtr) = operacion(ACOS, 1, (yyvsp[-1].nPtr)); }
#line 1514 "v.tab.c"
    break;

  case 34: /* expression: TAN '(' expression ')'  */
#line 89 "v.y"
                                    { (yyval.nPtr) = operacion(TAN, 1, (yyvsp[-1].nPtr)); }
#line 1520 "v.tab.c"
    break;

  case 35: /* expression: ATAN '(' expression ')'  */
#line 90 "v.y"
                                     { (yyval.nPtr) = operacion(ATAN, 1, (yyvsp[-1].nPtr)); }
#line 1526 "v.tab.c"
    break;

  case 36: /* expression: '-' expression  */
#line 91 "v.y"
                                         { (yyval.nPtr) = operacion(UMINUS, 1, (yyvsp[0].nPtr)); }
#line 1532 "v.tab.c"
    break;

  case 37: /* expression: expression '^' expression  */
#line 92 "v.y"
                                       { (yyval.nPtr) = operacion('^', 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1538 "v.tab.c"
    break;
...
#line 100 "v.y"
                                      { (yyval.nPtr) = operacion(GE, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1586 "v.tab.c"
    break;

  case 46: /* expression: expression LE expression  */
#line 101 "v.y"
                                      { (yyval.nPtr) = operacion(LE, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1592 "v.tab.c"
    break;
...
#line 103 "v.y"
                                      { (yyval.nPtr) = operacion(NE, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1604 "v.tab.c"
    break;

  case 49: /* expression: expression AND expression  */
#line 104 "v.y"
                                       { (yyval.nPtr) = operacion(AND, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1610 "v.tab.c"
    break;

  case 50: /* expression: expression OR expression  */
#line 105 "v.y"
                                      { (yyval.nPtr) = operacion(OR, 2, (yyvsp[-2].nPtr), (yyvsp[0].nPtr)); }
#line 1616 "v.tab.c"
    break;

  case 51: /* expression: NOT expression  */
#line 106 "v.y"
                            { (yyval.nPtr) = operacion(NOT, 1, (yyvsp[0].nPtr)); }
#line 1622 "v.tab.c"
    break;
