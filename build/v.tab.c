...
/* Line 1455 of yacc.c  */
#line 53 "v.y"
    { expresion((yyvsp[(2) - (2)].nPtr)); nodo_libre((yyvsp[(2) - (2)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 56 "v.y"
    { (yyval.nPtr) = operacion(';', 2, NULL, NULL); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 59 "v.y"
    { (yyval.nPtr) = operacion(ASSIGN, 2, id((yyvsp[(1) - (4)].vName), SET), (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 60 "v.y"
    { (yyval.nPtr) = operacion(PRINT, 1, (yyvsp[(2) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 61 "v.y"
    { (yyval.nPtr) = operacion(PRINT, 1, constante((yyvsp[(2) - (3)].sValue))); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 62 "v.y"
    { (yyval.nPtr) = operacion(SCAN, 1, id((yyvsp[(2) - (3)].vName), GET)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 63 "v.y"
    { (yyval.nPtr) = operacion(WHILE, 2, (yyvsp[(2) - (4)].nPtr), (yyvsp[(4) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 64 "v.y"
    { (yyval.nPtr) = operacion(FOR, 5, id((yyvsp[(2) - (12)].vName), GET), (yyvsp[(5) - (12)].nPtr), (yyvsp[(7) - (12)].nPtr), (yyvsp[(9) - (12)].nPtr), (yyvsp[(12) - (12)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 65 "v.y"
    { (yyval.nPtr) = operacion(IF, 2, (yyvsp[(2) - (4)].nPtr), (yyvsp[(4) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 66 "v.y"
    { (yyval.nPtr) = operacion(IF, 3, (yyvsp[(2) - (6)].nPtr), (yyvsp[(4) - (6)].nPtr), (yyvsp[(6) - (6)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 71 "v.y"
    { (yyval.nPtr) = operacion(';', 2, (yyvsp[(1) - (2)].nPtr), (yyvsp[(2) - (2)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 74 "v.y"
    { (yyval.nPtr) = condicion((yyvsp[(1) - (1)].dValue)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 77 "v.y"
    { (yyval.nPtr) = operacion(RANDOM, 2, (yyvsp[(3) - (6)].nPtr), (yyvsp[(5) - (6)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 78 "v.y"
    { (yyval.nPtr) = operacion(LOG, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 79 "v.y"
    { (yyval.nPtr) = operacion(LOG, 2, (yyvsp[(3) - (6)].nPtr), (yyvsp[(5) - (6)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 80 "v.y"
    { (yyval.nPtr) = operacion(EXP, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 81 "v.y"
    { (yyval.nPtr) = operacion(SQRT, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 82 "v.y"
    { (yyval.nPtr) = operacion(FLOOR, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 83 "v.y"
    { (yyval.nPtr) = operacion(CEIL, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 84 "v.y"
    { (yyval.nPtr) = operacion(ABS, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 85 "v.y"
    { (yyval.nPtr) = operacion(SIN, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 86 "v.y"
    { (yyval.nPtr) = operacion(ASIN, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 87 "v.y"
    { (yyval.nPtr) = operacion(COS, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 88 "v.y"
    { (yyval.nPtr) = operacion(ACOS, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 89 "v.y"
    { (yyval.nPtr) = operacion(TAN, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 90 "v.y"
    { (yyval.nPtr) = operacion(ATAN, 1, (yyvsp[(3) - (4)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 91 "v.y"
    { (yyval.nPtr) = operacion(UMINUS, 1, (yyvsp[(2) - (2)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 92 "v.y"
    { (yyval.nPtr) = operacion('^', 2, (yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 100 "v.y"
    { (yyval.nPtr) = operacion(GE, 2, (yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 101 "v.y"
    { (yyval.nPtr) = operacion(LE, 2, (yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 103 "v.y"
    { (yyval.nPtr) = operacion(NE, 2, (yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 104 "v.y"
    { (yyval.nPtr) = operacion(AND, 2, (yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 105 "v.y"
    { (yyval.nPtr) = operacion(OR, 2, (yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 106 "v.y"
    { (yyval.nPtr) = operacion(NOT, 1, (yyvsp[(2) - (2)].nPtr)); ;}
    break;
